define([
    ...
    return declare([_WidgetBase, _TemplatedMixin], {
        ...
        // These tipically map to whatever you're passing to the constructor
        name: "No Name",
        ...
        postCreate: function() {
            ...
            this.own(
                ...
                on(domNode, mouse.leave, lang.hitch(this, "_changeBackground", this.mouseBackgroundColor))
            );
        },
        ...
        _setAvatarAttr: function(imagePath) {
            ...
            if (imagePath !="") {
                // Save it on our widget instance - node that
